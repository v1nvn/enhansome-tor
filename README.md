...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,248 | 🐛 4 | 🌐 Go | 📅 2026-04-27 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,036 | 🐛 10 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,219 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
* [rotating-proxy](https://github.com/mattes/rotating-proxy) ⭐ 1,207 | 🐛 24 | 🌐 Ruby | 📅 2024-04-25 - Rotating Tor proxy with Docker.
* [multitor](https://github.com/trimstray/multitor) ⭐ 1,154 | 🐛 23 | 🌐 Shell | 📅 2024-11-19 - Create multiple Tor instances with load balancing.
...
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 257 | 🐛 9 | 🌐 HTML | 📅 2026-04-27 - This is an ansible role for tor relay operators.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,698 | 🐛 95 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,467 | 🐛 28 | 🌐 Dart | 📅 2026-04-28 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 8,539 | 🐛 12 | 🌐 C++ | 📅 2026-04-21 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,735 | 🐛 332 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
* [Firefly](https://github.com/yinghuocho/firefly-proxy) ⭐ 4,820 | 🐛 500 | 🌐 Go | 📅 2018-11-14 - A proxy software to help circumvent the Great Firewall.
* [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) ⭐ 2,343 | 🐛 171 | 🌐 JavaScript | 📅 2025-12-13 - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,805 | 🐛 471 | 🌐 Python | 📅 2026-04-27 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
