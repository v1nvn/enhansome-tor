...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,029 | 🐛 3 | 🌐 Go | 📅 2026-02-16 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 3,774 | 🐛 9 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,205 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
...
* [TorChat](https://github.com/prof7bit/TorChat) ⭐ 987 | 🐛 70 | 🌐 Pascal | 📅 2018-10-22 - Decentralized anonymous instant messenger on top of Tor Hidden Services.
...
* [torDDoS](https://github.com/r3nt0n/torDDoS) ⭐ 392 | 🐛 1 | 🌐 Python | 📅 2023-07-27 - TorDDos is a Python tool to automatize DDoS attacks on a website from the Tor network.
...
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,230 | 🐛 14 | 🌐 Dart | 📅 2026-02-19 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 7,604 | 🐛 16 | 🌐 C++ | 📅 2025-12-17 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,016 | 🐛 321 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
...
* [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) ⭐ 2,307 | 🐛 167 | 🌐 JavaScript | 📅 2025-12-13 - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,776 | 🐛 462 | 🌐 Python | 📅 2026-02-18 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
