...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,241 | 🐛 3 | 🌐 Go | 📅 2026-04-24 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,029 | 🐛 10 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,218 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
* [rotating-proxy](https://github.com/mattes/rotating-proxy) ⭐ 1,207 | 🐛 24 | 🌐 Ruby | 📅 2024-04-25 - Rotating Tor proxy with Docker.
* [multitor](https://github.com/trimstray/multitor) ⭐ 1,153 | 🐛 23 | 🌐 Shell | 📅 2024-11-19 - Create multiple Tor instances with load balancing.
...
* [Tallow](https://github.com/basil00/TorWall) ⭐ 559 | 🐛 18 | 🌐 C | 📅 2021-09-11 - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
...
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 257 | 🐛 9 | 🌐 HTML | 📅 2026-04-18 - This is an ansible role for tor relay operators.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,691 | 🐛 95 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,463 | 🐛 31 | 🌐 Dart | 📅 2026-04-25 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 8,506 | 🐛 12 | 🌐 C++ | 📅 2026-04-21 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,725 | 🐛 332 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
* [Firefly](https://github.com/yinghuocho/firefly-proxy) ⭐ 4,823 | 🐛 500 | 🌐 Go | 📅 2018-11-14 - A proxy software to help circumvent the Great Firewall.
* [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) ⭐ 2,342 | 🐛 171 | 🌐 JavaScript | 📅 2025-12-13 - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
...
* [Anarcho-Tech NYC Wiki](https://github.com/AnarchoTechNYC/meta/wiki) ⭐ 512 | 🐛 1 | 🌐 HTML | 📅 2025-08-17 - Wiki that explains how to stay private and anonymous online.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,806 | 🐛 471 | 🌐 Python | 📅 2026-04-25 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
