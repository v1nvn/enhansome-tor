...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 12,951 | 🐛 4 | 🌐 Go | 📅 2026-02-06 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 3,760 | 🐛 9 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [rotating-proxy](https://github.com/mattes/rotating-proxy) ⭐ 1,202 | 🐛 24 | 🌐 Ruby | 📅 2024-04-25 - Rotating Tor proxy with Docker.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,199 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
* [multitor](https://github.com/trimstray/multitor) ⭐ 1,139 | 🐛 23 | 🌐 Shell | 📅 2024-11-19 - Create multiple Tor instances with load balancing.
* [TorChat](https://github.com/prof7bit/TorChat) ⭐ 985 | 🐛 70 | 🌐 Pascal | 📅 2018-10-22 - Decentralized anonymous instant messenger on top of Tor Hidden Services.
* [bine](https://github.com/cretz/bine) ⭐ 806 | 🐛 27 | 🌐 Go | 📅 2023-07-28 - Go library for accessing and embedding Tor clients and servers.
* [eotk](https://github.com/alecmuffett/eotk) ⭐ 787 | 🐛 19 | 🌐 Awk | 📅 2024-02-09 - Tool for deploying HTTP/Onion sites to provide official, onion-networking for popular websites.
* [Tor2web](https://github.com/tor2web/Tor2web) ⭐ 744 | 🐛 167 | 🌐 Python | 📅 2024-05-24 - HTTP proxy software that enables access to Tor Hidden Services through common web browsers.
* [node-Tor](https://github.com/Ayms/node-Tor) ⭐ 721 | 🐛 2 | 🌐 JavaScript | 📅 2022-08-29 - JavaScript open-source implementation of the Tor protocol on the server side and browsers.
* [tor-browser-selenium](https://github.com/webfp/tor-browser-selenium) ⭐ 586 | 🐛 8 | 🌐 Python | 📅 2025-07-26 - A Python library to automate Tor Browser with Selenium WebDriver.
* [Tallow](https://github.com/basil00/TorWall) ⭐ 555 | 🐛 17 | 🌐 C | 📅 2021-09-11 - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
* [tor-controller](https://github.com/kragniz/tor-controller) ⭐ 536 | 🐛 10 | 🌐 Go | 📅 2021-09-26 - Run Tor Onion Services on Kubernetes.
* [toriptabkes2](https://github.com/ruped24/toriptables2) ⭐ 487 | 🐛 0 | 🌐 Python | 📅 2025-07-31 - An anonymizer that sets up iptables and Tor to route all traffic through the Tor network.
* [mini-tor](https://github.com/wbenny/mini-tor) ⭐ 407 | 🐛 7 | 🌐 C++ | 📅 2019-04-09 - Smallest application size while accessing internet content and hidden service content.
* [torDDoS](https://github.com/r3nt0n/torDDoS) ⭐ 391 | 🐛 1 | 🌐 Python | 📅 2023-07-27 - TorDDos is a Python tool to automatize DDoS attacks on a website from the Tor network.
* [haskell-tor](https://github.com/GaloisInc/haskell-tor) ⭐ 274 | 🐛 25 | 🌐 Haskell | 📅 2017-11-03 - A Haskell implementation of the Tor protocol.
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 256 | 🐛 12 | 🌐 HTML | 📅 2025-10-14 - This is an ansible role for tor relay operators.
* [Tor.framework](https://github.com/iCepa/Tor.framework) ⭐ 251 | 🐛 7 | 🌐 Objective-C | 📅 2026-02-04 - Tor.framework is the easiest way to embed Tor in your iOS application.
* [Vanguards](https://github.com/mikeperry-tor/vanguards) ⭐ 240 | 🐛 29 | 🌐 Python | 📅 2024-07-06 - This addon protects against guard discovery and related traffic analysis attacks.
* [Tor\_Onion\_Proxy](https://github.com/thaliproject/Tor_Onion_Proxy_Library) ⭐ 185 | 🐛 44 | 🌐 Java | 📅 2024-06-09 - Provides a .JAR and an .AAR file for embedding Tor into a Java or Android Program.
* [tor-relay-bootstrap](https://github.com/coldhakca/tor-relay-bootstrap) ⭐ 146 | 🐛 10 | 🌐 Shell | 📅 2023-09-01 - Script to bootstrap a Debian server to be a set-and-forget Tor relay.
* [tor.rb](https://github.com/dryruby/tor.rb) ⭐ 117 | 🐛 1 | 🌐 Ruby | 📅 2024-07-07 - This is a Ruby library for interacting with the Tor anonymity network.
* [tor\_box](https://github.com/CMoncur/tor_box) ⭐ 113 | 🐛 1 | 🌐 Shell | 📅 2018-04-17 - An all-inclusive Tor configuration for Raspberry Pi, that serves as a relay and personal Tor network.
* [tun2tor](https://github.com/iCepa/tun2tor) ⭐ 105 | 🐛 7 | 🌐 Rust | 📅 2021-11-14 - Rust library that creates a utun (userspace tunnel) interface, and connects it to a stream-based proxy.
* [php-torcontrol](https://github.com/dunglas/php-torcontrol) ⭐ 88 | 🐛 1 | 🌐 PHP | 📅 2018-08-09 - TorControl is a PHP library to control a Tor server.
* [torps](https://github.com/torps/torps) ⭐ 87 | 🐛 11 | 🌐 C++ | 📅 2017-01-16 - The Tor Path Simulator (TorPS) is a tool for efficiently simulating path selection in Tor.
* [offensive-tor-toolkit](https://github.com/atorrescogollo/offensive-tor-toolkit) ⭐ 61 | 🐛 1 | 🌐 Go | 📅 2021-07-03 - Bind/Reverse Shells, SOCKS, etc over Tor in Go.
* [dos-over-tor](https://github.com/skizap/dos-over-tor) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2018-07-21 - Proof of concept denial of service over Tor stress test tool.
* [Stormy](https://github.com/glamrock/stormy) ⭐ 40 | 🐛 5 | 🌐 Python | 📅 2015-06-03 - Stormy is a wizard that helps people create Tor Onion Services with just a few clicks.
* [onion-grater](https://github.com/Whonix/onion-grater) ⭐ 10 | 🐛 3 | 🌐 Python | 📅 2026-01-11 - Whitelisting filter for dangerous Tor control protocol commands.
* [setup-tor](https://github.com/tor-actions/setup-tor) ⭐ 9 | 🐛 7 | 🌐 TypeScript | 📅 2024-07-29 - Set up your GitHub Actions workflow with a specific version of Tor.
...
* [tor\_ssh.sh](https://gitlab.com/grownetics/devops/blob/master/tor_ssh.sh) - Command that allows SSH access using Tor to any server.
...
* [ScrambleSuit](https://github.com/NullHypothesis/scramblesuit) ⭐ 95 | 🐛 0 | 🌐 Python | 📅 2014-07-12 - Outdated and deprecated bridge type. A pluggable transport protocol for obfsproxy. It is written in pure Python.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,621 | 🐛 94 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,219 | 🐛 16 | 🌐 Dart | 📅 2026-02-07 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 7,573 | 🐛 14 | 🌐 C++ | 📅 2025-12-17 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 5,644 | 🐛 317 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
* [Firefly](https://github.com/yinghuocho/firefly-proxy) ⭐ 4,838 | 🐛 500 | 🌐 Go | 📅 2018-11-14 - A proxy software to help circumvent the Great Firewall.
* [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) ⭐ 2,296 | 🐛 165 | 🌐 JavaScript | 📅 2025-12-13 - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
* [nodeunblocker](https://github.com/nfriedly/nodeunblocker.com) ⭐ 174 | 🐛 2 | 🌐 HTML | 📅 2024-10-17 - Host your copy of nodeunblocker.com using Node.js to bypass censorship on the internet.
* [FWlite](https://github.com/v3aqb/fwlite) ⭐ 138 | 🐛 5 | 🌐 Python | 📅 2024-02-17 - An anti-censorship HTTP proxy with built-in shadowsocks support.
...
* [Anarcho-Tech NYC Wiki](https://github.com/AnarchoTechNYC/meta/wiki) ⭐ 508 | 🐛 1 | 🌐 HTML | 📅 2025-08-17 - Wiki that explains how to stay private and anonymous online.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,767 | 🐛 464 | 🌐 Python | 📅 2026-02-06 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
