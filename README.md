...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,161 | 🐛 6 | 🌐 Go | 📅 2026-03-31 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 3,942 | 🐛 10 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,214 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
* [rotating-proxy](https://github.com/mattes/rotating-proxy) ⭐ 1,204 | 🐛 24 | 🌐 Ruby | 📅 2024-04-25 - Rotating Tor proxy with Docker.
* [multitor](https://github.com/trimstray/multitor) ⭐ 1,152 | 🐛 23 | 🌐 Shell | 📅 2024-11-19 - Create multiple Tor instances with load balancing.
...
* [Tor2web](https://github.com/tor2web/Tor2web) ⭐ 752 | 🐛 167 | 🌐 Python | 📅 2024-05-24 - HTTP proxy software that enables access to Tor Hidden Services through common web browsers.
...
* [Tallow](https://github.com/basil00/TorWall) ⭐ 559 | 🐛 17 | 🌐 C | 📅 2021-09-11 - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
* [tor-controller](https://github.com/kragniz/tor-controller) ⭐ 537 | 🐛 10 | 🌐 Go | 📅 2021-09-26 - Run Tor Onion Services on Kubernetes.
* [toriptabkes2](https://github.com/ruped24/toriptables2) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2025-07-31 - An anonymizer that sets up iptables and Tor to route all traffic through the Tor network.
...
* [Vanguards](https://github.com/mikeperry-tor/vanguards) ⭐ 241 | 🐛 29 | 🌐 Python | 📅 2024-07-06 - This addon protects against guard discovery and related traffic analysis attacks.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,652 | 🐛 95 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,335 | 🐛 18 | 🌐 Dart | 📅 2026-04-02 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 7,884 | 🐛 18 | 🌐 C++ | 📅 2025-12-17 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,540 | 🐛 329 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,796 | 🐛 467 | 🌐 Python | 📅 2026-04-02 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
