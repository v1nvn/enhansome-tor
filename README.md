...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,214 | 🐛 6 | 🌐 Go | 📅 2026-04-16 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,003 | 🐛 10 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,216 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
* [rotating-proxy](https://github.com/mattes/rotating-proxy) ⭐ 1,207 | 🐛 24 | 🌐 Ruby | 📅 2024-04-25 - Rotating Tor proxy with Docker.
* [multitor](https://github.com/trimstray/multitor) ⭐ 1,149 | 🐛 23 | 🌐 Shell | 📅 2024-11-19 - Create multiple Tor instances with load balancing.
* [TorChat](https://github.com/prof7bit/TorChat) ⭐ 991 | 🐛 68 | 🌐 Pascal | 📅 2018-10-22 - Decentralized anonymous instant messenger on top of Tor Hidden Services.
* [bine](https://github.com/cretz/bine) ⭐ 811 | 🐛 27 | 🌐 Go | 📅 2023-07-28 - Go library for accessing and embedding Tor clients and servers.
* [eotk](https://github.com/alecmuffett/eotk) ⭐ 788 | 🐛 19 | 🌐 Awk | 📅 2024-02-09 - Tool for deploying HTTP/Onion sites to provide official, onion-networking for popular websites.
* [Tor2web](https://github.com/tor2web/Tor2web) ⭐ 750 | 🐛 167 | 🌐 Python | 📅 2024-05-24 - HTTP proxy software that enables access to Tor Hidden Services through common web browsers.
* [node-Tor](https://github.com/Ayms/node-Tor) ⭐ 718 | 🐛 2 | 🌐 JavaScript | 📅 2022-08-29 - JavaScript open-source implementation of the Tor protocol on the server side and browsers.
* [tor-browser-selenium](https://github.com/webfp/tor-browser-selenium) ⭐ 584 | 🐛 12 | 🌐 Python | 📅 2025-07-26 - A Python library to automate Tor Browser with Selenium WebDriver.
* [Tallow](https://github.com/basil00/TorWall) ⭐ 558 | 🐛 18 | 🌐 C | 📅 2021-09-11 - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
* [tor-controller](https://github.com/kragniz/tor-controller) ⭐ 536 | 🐛 10 | 🌐 Go | 📅 2021-09-26 - Run Tor Onion Services on Kubernetes.
* [toriptabkes2](https://github.com/ruped24/toriptables2) ⭐ 488 | 🐛 0 | 🌐 Python | 📅 2025-07-31 - An anonymizer that sets up iptables and Tor to route all traffic through the Tor network.
...
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 257 | 🐛 8 | 🌐 HTML | 📅 2026-04-18 - This is an ansible role for tor relay operators.
* [Tor.framework](https://github.com/iCepa/Tor.framework) ⭐ 253 | 🐛 7 | 🌐 Objective-C | 📅 2026-04-01 - Tor.framework is the easiest way to embed Tor in your iOS application.
* [Vanguards](https://github.com/mikeperry-tor/vanguards) ⭐ 242 | 🐛 29 | 🌐 Python | 📅 2024-07-06 - This addon protects against guard discovery and related traffic analysis attacks.
* [Tor\_Onion\_Proxy](https://github.com/thaliproject/Tor_Onion_Proxy_Library) ⭐ 184 | 🐛 44 | 🌐 Java | 📅 2024-06-09 - Provides a .JAR and an .AAR file for embedding Tor into a Java or Android Program.
* [tor-relay-bootstrap](https://github.com/coldhakca/tor-relay-bootstrap) ⭐ 147 | 🐛 10 | 🌐 Shell | 📅 2023-09-01 - Script to bootstrap a Debian server to be a set-and-forget Tor relay.
...
* [php-torcontrol](https://github.com/dunglas/php-torcontrol) ⭐ 87 | 🐛 1 | 🌐 PHP | 📅 2018-08-09 - TorControl is a PHP library to control a Tor server.
...
* [offensive-tor-toolkit](https://github.com/atorrescogollo/offensive-tor-toolkit) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2021-07-03 - Bind/Reverse Shells, SOCKS, etc over Tor in Go.
* [dos-over-tor](https://github.com/skizap/dos-over-tor) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2026-02-23 - Proof of concept denial of service over Tor stress test tool.
...
* [onion-grater](https://github.com/Whonix/onion-grater) ⭐ 11 | 🐛 3 | 🌐 Python | 📅 2026-03-28 - Whitelisting filter for dangerous Tor control protocol commands.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,679 | 🐛 95 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,440 | 🐛 29 | 🌐 Dart | 📅 2026-04-19 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 8,401 | 🐛 15 | 🌐 C++ | 📅 2026-04-08 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 6,702 | 🐛 331 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
* [Firefly](https://github.com/yinghuocho/firefly-proxy) ⭐ 4,825 | 🐛 500 | 🌐 Go | 📅 2018-11-14 - A proxy software to help circumvent the Great Firewall.
* [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) ⭐ 2,336 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-13 - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
...
* [Anarcho-Tech NYC Wiki](https://github.com/AnarchoTechNYC/meta/wiki) ⭐ 510 | 🐛 1 | 🌐 HTML | 📅 2025-08-17 - Wiki that explains how to stay private and anonymous online.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,805 | 🐛 468 | 🌐 Python | 📅 2026-04-19 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
