...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,001 | 🐛 3 | 🌐 Go | 📅 2026-02-16 - A flexible DNS proxy, with support for encrypted DNS protocols.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 3,768 | 🐛 9 | 🌐 Python | 📅 2026-01-08 - Onion site crawler for data collection.
* [kalitorify](https://github.com/brainfucksec/kalitorify) ⭐ 1,204 | 🐛 1 | 🌐 Shell | 📅 2024-04-18 - Shell script to create a transparent proxy through Tor for Kali Linux OS.
...
* [Tor2web](https://github.com/tor2web/Tor2web) ⭐ 747 | 🐛 167 | 🌐 Python | 📅 2024-05-24 - HTTP proxy software that enables access to Tor Hidden Services through common web browsers.
...
* [tor-browser-selenium](https://github.com/webfp/tor-browser-selenium) ⭐ 585 | 🐛 9 | 🌐 Python | 📅 2025-07-26 - A Python library to automate Tor Browser with Selenium WebDriver.
* [Tallow](https://github.com/basil00/TorWall) ⭐ 556 | 🐛 17 | 🌐 C | 📅 2021-09-11 - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
...
* [ansible-relayor](https://github.com/nusenu/ansible-relayor) ⭐ 256 | 🐛 8 | 🌐 HTML | 📅 2026-02-15 - This is an ansible role for tor relay operators.
...
* [trojan](https://github.com/trojan-gfw/trojan) ⭐ 19,623 | 🐛 94 | 🌐 C++ | 📅 2024-08-21 - An unidentifiable mechanism that helps you bypass GFW.
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,230 | 🐛 13 | 🌐 Dart | 📅 2026-02-17 - Censorship circumvention tool available for free download on any operating system.
* [NaïveProxy](https://github.com/klzgrad/naiveproxy) ⭐ 7,599 | 🐛 16 | 🌐 C++ | 📅 2025-12-17 - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
* [MTProxy](https://github.com/TelegramMessenger/MTProxy) ⭐ 5,986 | 🐛 321 | 🌐 C | 📅 2025-11-04 - Allows users in censored areas to connect to Telegram.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,773 | 🐛 464 | 🌐 Python | 📅 2026-02-16 - SecureDrop is an open-source whistleblower submission system that media organizations and NGOs can install to securely accept documents from anonymous sources.
